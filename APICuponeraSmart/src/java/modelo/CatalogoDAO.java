...
public class CatalogoDAO {
    ...
    public static List<PromoSucursal> obtenerPromoSucursal(){
        List<PromoSucursal> promoSucursal = new ArrayList<>();
        SqlSession conexionBD = MyBatisUtil.getSession();
        if(conexionBD != null){
            try{
                promoSucursal = conexionBD.selectList("catalogo.obtenerPromoSucursal");
            }catch (Exception e){
                e.printStackTrace();
            }finally{
                conexionBD.close();
